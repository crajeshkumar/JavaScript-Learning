...
re = /^\w$/;   // Any one alpha_numberic character or _
re = /^\w+$/;  // + = one or more 
re = /\W/;  // Matches except alpha_numberic character or _
re = /^\W$/;  // Matches except alpha_numberic character or _ one or more
re = /\d/;  // Matches only digits
re = /\d+/;  // Matches only digits one or more
re = /\D/;  // Matches except digits
re = /\D+/;  // Matches except digits one or more
re = /\s/;  // Matches only spaces
re = /\s+/;  // Matches only spaces
re = /\S/;  // Matches except spaces
re = /\S+/;  // Matches except spaces one or more


// Assertions
re = /x(?=y)/; //Matches only if y follows x
re = /x(?!y)/; //Matches only if y not follows x


const str ='cvhjkpoiuygxyghj';
